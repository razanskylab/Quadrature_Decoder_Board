...
namespace mlSerial {  
  ...
  /******************************************************************************/
  void MLSerial::Serial_Write_Float(float writeData){
    flwriteBuffer_.val = writeData;
    Serial.write(flwriteBuffer_.bytes, 4);
  }

  /******************************************************************************/
  void MLSerial::Serial_Write_Double(double writeData){
    doubwriteBuffer_.val = writeData;
    Serial.write(doubwriteBuffer_.bytes, 8);
  }
