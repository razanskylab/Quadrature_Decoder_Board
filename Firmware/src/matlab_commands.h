...
#define ML_COMMANDS
  ...
  constexpr char* MCU_ID = "coroam_brains"; // used to identify MCU


  // general communication commands -------------------------------------------
  // constexpr uint16_t DO_NOTHING = 0;
  constexpr uint16_t NO_NEW_COMMAND = 00; 
    // reserved as return value for no new command
  constexpr uint16_t CLOSE_CONNECTION = 94;
  ...
  constexpr uint16_t DISABLE_POS_TRIGGER = STOP;
  constexpr uint16_t START_FREE_RUNNING_TRIGGER = 66;
  // constexpr uint16_t DISABLE_SCOPE = 67;
